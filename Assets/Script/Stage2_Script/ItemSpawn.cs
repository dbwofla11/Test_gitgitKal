...
public class ItemSpawn : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Instantiate(doubleJump, new Vector2(20, 8), doubleJump.transform.rotation);
        Instantiate(doubleJump, new Vector2(20, 11), doubleJump.transform.rotation);
        Instantiate(doubleJump, new Vector2(20, 14), doubleJump.transform.rotation);
    }
    ...
    IEnumerator SpawnDoubleJump(Vector2 spawnPos)
    {
        yield return new WaitForSeconds(spawnTime);
